...
#The chart will be saved as pdf file locally
#also cna run it and show the chart on Juptyer notebook to visualize the loss values of the training data and validation data
